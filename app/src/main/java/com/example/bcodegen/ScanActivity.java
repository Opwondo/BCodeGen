...
public class ScanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        generateButton.setOnClickListener(v -> {
            ...
            try {
                ...
                Bitmap barcodeBitmap = encoder.createBitmap(writer.encode(
                        text, BarcodeFormat.CODE_128, 600, 300));
                ...
                db.barcodeDao().insertBarcode(new BarcodeEntity(text, "Generated", System.currentTimeMillis()));
        ...
        final ActivityResultLauncher<ScanOptions> barcodeLauncher = registerForActivityResult(new ScanContract(), result -> {
            if (result.getContents() != null) {
                ...
                // Save to Room Database
                BarcodeDatabase db = BarcodeDatabase.getInstance(this);
                db.barcodeDao().insertBarcode(new BarcodeEntity(barcodeData, "Scanned", timestamp));

                // Show barcode details in a dialog
                showBarcodeDetails(barcodeData);
            }
        });
    ...
    private void showBarcodeDetails(String barcodeData) {
        // Create a dialog to display the barcode details
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle("Barcode Details");
        builder.setMessage("Barcode Data: " + barcodeData);
    ...
    private void scanBarcodeFromImage(Uri imageUri) {
        try {
            ...
            scanner.process(image)
                    ...
                    .addOnFailureListener(e -> Toast.makeText(this, "Failed to scan", Toast.LENGTH_SHORT).show());
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
